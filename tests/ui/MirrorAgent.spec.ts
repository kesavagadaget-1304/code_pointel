...
test("@DCCM_SIT_TC_0027 @low Ensure while click on skill level column and enter valid value and click on apply button", async ({ }, testInfo) => {
    ...
    try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          await sharedPage.waitForTimeout(3000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_DIV_DROP).click({ timeout: 5000 });
          await scrollUntilVisible(sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_DIV_DCCM));
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_DIV_DCCM).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SEARCH).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.waitForLoadState('networkidle');
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_DIV_DCCM_INPUT).click();
          await sharedPage.waitForTimeout(3000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_DIV_DCCM_INPUT).focus();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_DIV_DCCM_INPUT).pressSequentially("amar02@gmail.com", { delay: 100 });
          await sharedPage.waitForTimeout(3000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_LABEL).click();
          await sharedPage.waitForTimeout(3000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_NEXT_BUTTON).click();
          ...
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SKILL_SEARCH_FILTER).click();
          await sharedPage.waitForTimeout(3000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SKILL_SEARCH_FILTER).focus();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SKILL_SEARCH_FILTER).pressSequentially("239", { delay: 100 });
          await sharedPage.waitForTimeout(3000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SKILL_USER_CHECKBOX).click({ timeout: 3000 });
          await sharedPage.waitForTimeout(1000);
          const DCCM_SIT_TC_0027_skill_value = await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SKILL_FIRST_CELL).innerText();
          console.log("Skill available in user page: " + DCCM_SIT_TC_0027_skill_value);
          ...
          await propFilter.fill(DCCM_SIT_TC_0027_skill_value);
  ...
  /*
test("@DCCM_SIT_TC_0028 @low Ensure while click on skill level column and enter Invalid value and click on apply button", async ({ }, testInfo) => {
    try {
      await TestHelpers.executeTestStep(
        'Login → Accounting Activity (first time banner)',
        async () => {
     ...
     try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          const jobNameDCCM_SIT_TC_102 = faker.person.jobTitle();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_NAME).fill(jobNameDCCM_SIT_TC_102);
          console.log('Job Name for DCCM_SIT_TC_102:', jobNameDCCM_SIT_TC_102);
          await sharedPage.waitForTimeout(2000);
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              await jobNameFilter.fill(jobNameDCCM_SIT_TC_102, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  ...
                  if (text.includes(jobNameDCCM_SIT_TC_102)) {
          ...
          expect(sharedPage.locator(SELECTORS.DASHBOARD_REPORT_SCHEDULER_VALIDATE)).toHaveText(jobNameDCCM_SIT_TC_102);
    ...
    try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_ONCE).click();
          const jobNameDCCM_SIT_TC_106 = faker.person.jobTitle();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_NAME).fill(jobNameDCCM_SIT_TC_106);
          console.log('Job Name for DCCM_SIT_TC_106:', jobNameDCCM_SIT_TC_106);
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE_CURRENT).click();
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(jobNameDCCM_SIT_TC_106, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(jobNameDCCM_SIT_TC_106)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
          ...
          const text = await sharedPage.locator(SELECTORS.DASHBOARD_REPORT_SCHEDULER_VALIDATE).innerText();
          console.log('Completed Scheduled Job:', text);
          expect(sharedPage.locator(SELECTORS.DASHBOARD_REPORT_SCHEDULER_VALIDATE)).toHaveText(jobNameDCCM_SIT_TC_106);
      ...
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(jobNameDCCM_SIT_TC_0132, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(jobNameDCCM_SIT_TC_0132)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
        ...
        async () => {
          ...
          await sharedPage.waitForTimeout(8000);
                      ...
                      for (let i = 0; i < maxAttempt; i++) {
                          ...
                          // Apply the Job Name filter again if the grid cleared it
                          const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
                          await jobNameFilter.fill(jobNameDCCM_SIT_TC_0133, { timeout: 10000 });
                          await sharedPage.keyboard.press('Enter');
                          await sharedPage.waitForTimeout(3000);
      ...
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0133, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(SCH_NameDCCM_SIT_TC_0133)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
          ...
          await sharedPage.locator(SELECTORS.DASHBOARD_REPORT_SCHEDULER).click();
                    ...
                    await sharedPage.waitForTimeout(8000);
                      ...
                      for (let i = 0; i < maxAttempt; i++) {
                          ...
                          // Apply the Job Name filter again if the grid cleared it
                          const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
                          await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0137, { timeout: 10000 });
                          await sharedPage.keyboard.press('Enter');
                          await sharedPage.waitForTimeout(3000);
        ...
        async () => {
          ...
          await sharedPage.waitForTimeout(3000);
                    ...
                    for (let i = 0; i < maxAttempt; i++) {
                        ...
                        // Apply the Job Name filter again if the grid cleared it
                        const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
                        await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0141, { timeout: 10000 });
                        await sharedPage.keyboard.press('Enter');
                        await sharedPage.waitForTimeout(3000);
                        ...
                        if (await validatedJob.isHidden()) {
                            const text = (await validatedJob.innerText()).trim();
                            if (text.includes(SCH_NameDCCM_SIT_TC_0141)) {
                                console.log('Success! Job not found in Current status:', text);
                                jobnotFound = false;
                                break; // Exit the loop early if found
                            }
          ...
          await sharedPage.waitForTimeout(1000);
                    ...
                    await sharedPage.waitForLoadState('domcontentloaded');
                    await sharedPage.waitForTimeout(3000);
                    console.log("Completed test case DCCM_SIT_TC_0141");
        ...
        async () => {
          ...
          await sharedPage.locator(SELECTORS.DASHBOARD_REPORT_SCHEDULER).click();
                    ...
                    for (let i = 0; i < maxAttempt; i++) {
                        ...
                        // Apply the Job Name filter again if the grid cleared it
                        const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
                        await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0145, { timeout: 10000 });
                        await sharedPage.keyboard.press('Enter');
                        await sharedPage.waitForTimeout(3000);
                        ...
                        if (await validatedJob.isHidden()) {
                            const text = (await validatedJob.innerText()).trim();
                            if (text.includes(SCH_NameDCCM_SIT_TC_0145)) {
                                console.log('Success! Job not found in Current status:', text);
                                jobnotFound = false;
                                break; // Exit the loop early if found
                            }
        ...
        async () => {
          ...
          await sharedPage.locator(SELECTORS.DASHBOARD_REPORT_SCHEDULER).click();
                    ...
                    for (let i = 0; i < maxAttempt; i++) {
                        ...
                        // Apply the Job Name filter again if the grid cleared it
                        const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
                        await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0146, { timeout: 10000 });
                        await sharedPage.keyboard.press('Enter');
                        await sharedPage.waitForTimeout(3000);
                        ...
                        if (await validatedJob.isHidden()) {
                            const text = (await validatedJob.innerText()).trim();
                            if (text.includes(SCH_NameDCCM_SIT_TC_0146)) {
                                console.log('Success! Job not found in Current status:', text);
                                jobnotFound = false;
                                break; // Exit the loop early if found
                            }
     ...
     try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          await sharedPage.locator(SELECTORS.DASHBOARD_AGENTS).click();
          await sharedPage.waitForLoadState('networkidle');
          const username0147=await sharedPage.locator(SELECTORS.AGENTS_USERNAME_COPY).textContent();
          console.log("Username is :",username0147);
          await sharedPage.locator(SELECTORS.AGENTS_USERNAME_SEARCH_TEXTBOX).fill(username0147?.trim() || '');
          await sharedPage.locator(SELECTORS.AGENTS_USERNAME_SEARCH_TEXTBOX).fill(username0147?.trim() || '');
          await sharedPage.locator(SELECTORS.AGENTS_USERNAME_SEARCH_TEXTBOX).press('Enter');
          await sharedPage.waitForTimeout(5000);
          await sharedPage.locator(SELECTORS.AGENTS_CHECKBOX1).click();
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_NEXT_BUTTON).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SKILLS_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_WORKTEAM_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SELECT_ATTRIBUTES_NEXT_BUTTON).click();
          await sharedPage.waitForTimeout(2000);
          await ScreenshotUtils.capture(sharedPage, testInfo, 'SELECT_NEXT');
          await sharedPage.waitForTimeout(2000);
          const DCCM_SIT_TC_0147=await sharedPage.locator(SELECTORS.AGENT_WORKTEAM_VALUE).inputValue();
          console.log("Workteam value :",DCCM_SIT_TC_0147);
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_HISTORY_USER).click();
          await sharedPage.waitForTimeout(5000);
          const historyCurrentVAlue = await sharedPage.locator(SELECTORS.HISTORY_PROP_NAME).textContent() ?? '';
          console.log("History Current Value is :",historyCurrentVAlue);
          await sharedPage.waitForTimeout(5000);
          expect(parseFloat(historyCurrentVAlue)).toBe(parseFloat(DCCM_SIT_TC_0147));
          await sharedPage.waitForTimeout(2000);
          //expect(sharedPage.locator(SELECTORS.HISTORY_CURRENT_VALUE)).toHaveText(DCCM_SIT_TC_0027);
          await sharedPage.locator(SELECTORS.HISTORY_CLOSE).click();
          await sharedPage.waitForTimeout(5000);
     ...
     try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          await sharedPage.waitForTimeout(5000);
          const username0148_1=await sharedPage.locator(SELECTORS.AGENTS_USERNAME_COPY).textContent();
          console.log("Copied attribute name is :",username0148_1);
          await sharedPage.locator(SELECTORS.AGENTS_CHECKBOX1).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_SEARCH).click();
          await sharedPage.waitForTimeout(3000);
          ...
          await sharedPage.waitForTimeout(3000);
          const username0148_2=await sharedPage.locator(SELECTORS.AGENTS_USERNAME_COPY).textContent();
          console.log("Copied attribute name is :",username0148_2);
          await sharedPage.locator(SELECTORS.AGENTS_CHECKBOX1).click();
          await sharedPage.waitForTimeout(5000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_SEARCH).clear();
  ...
  try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_ONCE).click();
          const jobNameDCCM_SIT_TC_0149 = faker.person.jobTitle();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_NAME).fill(jobNameDCCM_SIT_TC_0149);
          console.log('Job Name for DCCM_SIT_TC_0149:', jobNameDCCM_SIT_TC_0149);
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE_CURRENT).click();
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(jobNameDCCM_SIT_TC_0149, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(jobNameDCCM_SIT_TC_0149)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
    ...
    try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          await sharedPage.waitForLoadState('domcontentloaded');
          await sharedPage.waitForTimeout(3000);
          await sharedPage.locator(SELECTORS.AGENTS_USERNAME_SEARCH_TEXTBOX).fill(DCCM_USERS.USER_2);
          console.log("Copied attribute name is :", DCCM_USERS.USER_2);
          await sharedPage.locator(SELECTORS.AGENTS_USERNAME_SEARCH_TEXTBOX).press('Enter');
          await sharedPage.waitForTimeout(5000);
          await sharedPage.waitForLoadState('networkidle');
          await sharedPage.locator(SELECTORS.AGENTS_CHECKBOX1).click();
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_ONCE).click();
          const SCH_NameDCCM_SIT_TC_0151 = faker.person.jobTitle();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_NAME).fill(SCH_NameDCCM_SIT_TC_0151);
          console.log('Job Name for DCCM_SIT_TC_0151:', SCH_NameDCCM_SIT_TC_0151);
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE_CURRENT).click();
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0151, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(SCH_NameDCCM_SIT_TC_0151)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
          ...
          try{
            if (actualText === 'Failed to update same skill level might already available') {
            ...
            console.log(`Expected: 'Failed to update same skill level might already available' but found: '${actualText}'`);
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Report_Job_Failure');
            await expect(statusCell).toHaveText('Failed to update same skill level might already available', { timeout: 1000 });
            }}
            finally {
    ...
    try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          const DCCM_SIT_TC_0152 = await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_LANGUAGES_LABEL).textContent() ?? '';
          await sharedPage.waitForTimeout(2000);
          console.log("Label is: ", DCCM_SIT_TC_0152);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SELECT_ATTRIBUTES_NEXT_BUTTON).click();
          await sharedPage.waitForLoadState('networkidle');
          await sharedPage.waitForTimeout(5000);
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_ONCE).click();
          const SCH_NameDCCM_SIT_TC_0152 = faker.person.jobTitle();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_NAME).fill(SCH_NameDCCM_SIT_TC_0152);
          console.log('Job Name for DCCM_SIT_TC_0152:', SCH_NameDCCM_SIT_TC_0152);
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE_CURRENT).click();
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0152, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(SCH_NameDCCM_SIT_TC_0152)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
          ...
          console.log(`Detected Status: ${actualText}`);
          try{
            if (actualText === 'Failed to update same language level might already available') {
            console.log('--- TEST RESULT: PASS ---');
            await sharedPage.waitForTimeout(3000);
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Report_Job_Confirmation');
            await sharedPage.goto("https://cms.cloudstamp.net/dccm/cms/dashboard");
            ...
            console.log('--- TEST RESULT: FAIL ---');
            console.log(`Expected: 'Failed to update same language level might already available' but found: '${actualText}'`);
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Report_Job_Failure');
            await expect(statusCell).toHaveText('Failed to update same language level might already available', { timeout: 1000 });
            }}
            finally {
            console.log('Navigating to Dashboard for next test case...');
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Final_Status_Check');
    ...
    try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          await sharedPage.waitForLoadState('domcontentloaded');
          await sharedPage.waitForTimeout(3000);
          const username0153_1 = await sharedPage.locator(SELECTORS.AGENTS_USERNAME_COPY).textContent();
          const username0153_2 = await sharedPage.locator(SELECTORS.AGENTS_USERNAME2_COPY).textContent();
          const username0153_3 = await sharedPage.locator(SELECTORS.AGENTS_USERNAME3_COPY).textContent();
          console.log("Copied attribute name is :", username0153_1);
          console.log("Copied attribute name is :", username0153_2);
          console.log("Copied attribute name is :", username0153_3);
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SKILLS_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_PHONE_LABEL).click();
          const DCCM_SIT_TC_0153 = await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_PHONE_LABEL).textContent() ?? '';
          await sharedPage.waitForTimeout(2000);
          console.log("Label is : ", DCCM_SIT_TC_0153);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SELECT_ATTRIBUTES_NEXT_BUTTON).click();
          await sharedPage.waitForLoadState('networkidle');
          await sharedPage.waitForTimeout(5000);
          const jobNameDCCM_SIT_TC_0153 = faker.person.jobDescriptor();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_PHONE_NAME).fill(jobNameDCCM_SIT_TC_0153);
          console.log('Phone Name for DCCM_SIT_TC_0153:', jobNameDCCM_SIT_TC_0153);
          await sharedPage.waitForTimeout(2000);
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_ONCE).click();
          const SCH_NameDCCM_SIT_TC_0153 = faker.person.jobTitle();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_NAME).fill(SCH_NameDCCM_SIT_TC_0153);
          console.log('Job Name for DCCM_SIT_TC_0153:', SCH_NameDCCM_SIT_TC_0153);
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE_CURRENT).click();
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0153, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(SCH_NameDCCM_SIT_TC_0153)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
          ...
          console.log(`Detected Status: ${actualText}`);
          try{
            if (actualText === 'Failed, User already has a phone') {
            console.log('--- TEST RESULT: PASS ---');
            await sharedPage.waitForTimeout(3000);
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Report_Job_Confirmation');
            await sharedPage.goto("https://cms.cloudstamp.net/dccm/cms/dashboard");
            ...
            console.log('--- TEST RESULT: FAIL ---');
            console.log(`Expected: 'Failed, User already has a phone' but found: '${actualText}'`);
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Report_Job_Failure');
            await expect(statusCell).toHaveText('Failed, User already has a phone', { timeout: 1000 });
            }}
            finally {
            console.log('Navigating to Dashboard for next test case...');
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Final_Status_Check');
    ...
    try {
      await TestHelpers.executeTestStep(
        ...
        async () => {
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_SEARCH).pressSequentially("cmstestuser@gmail.com", { delay: 100 });
          await sharedPage.waitForTimeout(5000);
          const username0155_1=await sharedPage.locator(SELECTORS.AGENTS_USERNAME_COPY).textContent();
          console.log("Copied attribute name is :",username0155_1);
          await sharedPage.locator(SELECTORS.AGENTS_CHECKBOX1).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_SEARCH).click();
          await sharedPage.waitForTimeout(3000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_SEARCH).clear();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_SEARCH).pressSequentially("cmstestuser2@gmail.com", { delay: 100 });
          await sharedPage.waitForTimeout(3000);
          const username0155_2=await sharedPage.locator(SELECTORS.AGENTS_USERNAME_COPY).textContent();
          console.log("Copied attribute name is :",username0155_2);
          await sharedPage.locator(SELECTORS.AGENTS_CHECKBOX1).click();
          await sharedPage.waitForTimeout(5000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_SEARCH).clear();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_SEARCH).pressSequentially("cmstestuser", { delay: 100 });
          ...
          await sharedPage.waitForTimeout(1000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_DIV_DCCM_INPUT).focus();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_DIV_DCCM_INPUT).pressSequentially("amar01@gmail.com", { delay: 100 });
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_USERNAME_LABEL).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_NEXT_BUTTON).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SKILLS_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_ROLES_LABEL).click();
          const DCCM_SIT_TC_0154 = await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_ROLES_LABEL).textContent() ?? '';
          await sharedPage.waitForTimeout(2000);
          console.log("Label is :", DCCM_SIT_TC_0154);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SELECT_ATTRIBUTES_NEXT_BUTTON).click();
          await sharedPage.waitForLoadState('networkidle');
          await sharedPage.waitForTimeout(5000);
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_ONCE).click();
          const SCH_NameDCCM_SIT_TC_0154 = faker.person.jobTitle();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_NAME).fill(SCH_NameDCCM_SIT_TC_0154);
          console.log('Job Name for DCCM_SIT_TC_0154:', SCH_NameDCCM_SIT_TC_0154);
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE_CURRENT).click();
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(SCH_NameDCCM_SIT_TC_0154, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(SCH_NameDCCM_SIT_TC_0154)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
          ...
          console.log(`Detected Status: ${actualText}`);
          try{
            if (actualText === 'Failed to Add, role/division already available') {
            console.log('--- TEST RESULT: PASS ---');
            await sharedPage.waitForTimeout(3000);
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Report_Job_Confirmation');
            await sharedPage.goto("https://cms.cloudstamp.net/dccm/cms/dashboard");
            ...
            console.log('--- TEST RESULT: FAIL ---');
            console.log(`Expected: 'Failed to Add, role/division already available' but found: '${actualText}'`);
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Report_Job_Failure');
            await expect(statusCell).toHaveText('Failed to Add, role/division already available', { timeout: 1000 });
            }}
            finally {
            console.log('Navigating to Dashboard for next test case...');
            await ScreenshotUtils.capture(sharedPage, testInfo, 'Final_Status_Check');
...
test("@DCCM_SIT_TC_0155 @low Ensure while schedule the mirror divisions  for the selected user having same divisions", async ({ }, testInfo) => {
  test.setTimeout(300000);   
  try {
      await TestHelpers.executeTestStep(
        'Login → Accounting Activity (first time banner)',
        async () => {
          ...
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_LABEL).click();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_TYPE_ONCE).click();
          const jobNameDCCM_SIT_TC_0155 = faker.person.jobTitle();
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_JOB_NAME).fill(jobNameDCCM_SIT_TC_0155);
          console.log('Job Name for DCCM_SIT_TC_0155:', jobNameDCCM_SIT_TC_0155);
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE).click();
          await sharedPage.waitForTimeout(2000);
          await sharedPage.locator(SELECTORS.AGENTS_MIRRORAGENT_SCHEDULE_START_DATE_CURRENT).click();
          ...
          for (let i = 0; i < maxAttempt; i++) {
              ...
              // Apply the Job Name filter again if the grid cleared it
              const jobNameFilter = sharedPage.locator(SELECTORS.AGENTS_REPORT_JOBNAME_FILTER);
              await jobNameFilter.fill(jobNameDCCM_SIT_TC_0155, { timeout: 10000 });
              await sharedPage.keyboard.press('Enter');
              await sharedPage.waitForTimeout(3000);
              ...
              if (await validatedJob.isHidden()) {
                  const text = (await validatedJob.innerText()).trim();
                  if (text.includes(jobNameDCCM_SIT_TC_0155)) {
                      console.log('Success! Job not found in Current status:', text);
                      jobnotFound = false;
                      break; // Exit the loop early if found
                  }
