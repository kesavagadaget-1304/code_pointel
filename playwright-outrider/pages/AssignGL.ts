...
export class AssignGL {
  ...
  readonly payrollFailed: Locator;
  readonly payrollFailedCloseButton: Locator;
  readonly assignGL: Locator;
  readonly viewDetails: Locator;
  readonly payrollAssignmentsGLDropdown: Locator;
  readonly payrollAssignmentsHeaderTitle: Locator;
  ...
  constructor(page: Page) {
    ...
    this.payrollFailed = page.locator(SELECTORS.ACCOUNTING_ACTIVITY_PAYROLLFAILED);
    this.payrollFailedCloseButton = page.locator(SELECTORS.ACCOUNTING_ACTIVITY_CLOSE);
    this.assignGL = page.locator(SELECTORS.ACCOUNTING_ACTIVITY_ASSIGN_GL);
    this.viewDetails = page.locator(SELECTORS.ACCOUNTING_ACTIVITY_VIEW_DETAILS);
    this.payrollAssignmentsGLDropdown = page.locator(SELECTORS.PAYROLL_ASSIGNMENTS_GL_DROPDOWN);
    this.payrollAssignmentsHeaderTitle = page.getByTestId(SELECTORS.PAYROLL_ASSIGNMENTS_HEADERTITLE);
 ...
 // click payroll failed
 async clickPayrollFailed(): Promise<void> {
  try {
    await this.payrollFailed.waitFor({ state: 'visible', timeout: TIMEOUTS.ELEMENT_WAIT });
    await this.payrollFailed.click();
  } catch (error) {
    throw error;
  }
 }
